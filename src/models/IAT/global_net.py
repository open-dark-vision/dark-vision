...
from src.models.IAT.blocks import Mlp  # noqa: I900
...
class GlobalNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=64, num_heads=4, task_type="exp"):
        super().__init__()
...
if __name__ == "__main__":
    device = "mps"
    img = torch.Tensor(8, 3, 400, 600).to(device)
