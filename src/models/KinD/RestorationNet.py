...
class RestorationNet(nn.Module):
    def __init__(self):
        ...
        self.part_one = nn.Sequential(
            nn.Conv2d(4, 32, 3, dilation=1, padding=1),
        ...
        self.part_four = nn.Sequential(
            ...
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
            nn.Conv2d(256, 256, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
        )

        self.part_five = nn.Sequential(
            nn.MaxPool2d(2, stride=2, padding=0),
            nn.Conv2d(256, 512, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
            nn.Conv2d(512, 512, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
        )
        ...
        self.part_six = nn.Sequential(
            nn.Conv2d(512, 256, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
            nn.Conv2d(256, 256, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
        )
        ...
        self.part_seven = nn.Sequential(
            nn.Conv2d(256, 128, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
            nn.Conv2d(128, 128, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
        )
        ...
        self.part_eight = nn.Sequential(
            nn.Conv2d(128, 64, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
            nn.Conv2d(64, 64, 3, dilation=1, padding=1),
            nn.LeakyReLU(negative_slope=0.2, inplace=True),
        )
        ...
        self.part_ten = nn.Sequential(
            nn.Conv2d(32, 3, 3, dilation=1, padding=1),
            nn.Sigmoid(),
        )
