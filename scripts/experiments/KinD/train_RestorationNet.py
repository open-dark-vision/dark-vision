...
from src.configs.experiments import kind_config_restore as cfg  # noqa: I900
from src.datasets import LOLDecompositionDataModul  # noqa: I900
from src.models import LitKinD_restore  # noqa: I900
...
if __name__ == "__main__":
    ...
    model = LitKinD_restore(config=cfg, save_images=3)
